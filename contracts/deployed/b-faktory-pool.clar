      ...
      (define-constant CONTRACT_INITIALIZER 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.b-faktory-dex)
      ...
      (define-public (swap-b-to-a (amount uint) (min-y-out uint))
          (let (
              ...
              (try! (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.b-faktory pay-royalty amount dy-d 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token))
              ;; if we varialize these 2 fts
              ;; and asserts out on 2 variables set to these 2 fts then we have a standard contract for this
      ...
      (define-public (initialize-pool (lowest uint) (highest uint)) ;; highest = origin minus lowest
        (begin
           ...
           (try! (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.b-faktory transfer highest contract-caller CONTRACT none))
           (print {
